...
export interface RelativeRangeCacheInfo {
  ...
  refreshingRequest: DataQueryRequest<MyQuery>;
}
...
export class RelativeRangeCache {
  constructor(
    private responseDataMap: Map<RequestCacheId, DataFrameCacheInfo> = new Map<RequestCacheId, DataFrameCacheInfo>()
  ) {}
   ...
   */
  set(request: DataQueryRequest<MyQuery>, response: DataQueryResponse) {
   ...
   */
  get(request: DataQueryRequest<MyQuery>): RelativeRangeCacheInfo | undefined {
   ...
   * @param request DataQueryRequest<MyQuery> request to lookup cached data for
  ...
  private static parseCacheInfo(cachedDataInfo: DataFrameCacheInfo, request: DataQueryRequest<MyQuery>) {
  ...
  private static getRefreshingRequest(request: DataQueryRequest<MyQuery>, range: TimeRange) {
